...
public class view_payment_history extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_payment_history);
    ...
    class getenrolledpayment extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            json_url = "http://192.168.1.11/Onlineteaching/getenrolledcourses.php";
        }
            ...
            try {
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    if (jo.getString("email").equals(studentemail)) {
                        ...
                        payment = new ArrayAdapter(view_payment_history.this, android.R.layout.simple_spinner_dropdown_item, spinnercourses);
    ...
    class getenrolledpaymentdetails extends AsyncTask<Void, Void, String> {
        ...
        @Override
        protected void onPreExecute() {
            json_url = "http://192.168.1.11/Onlineteaching/paymentdetails.php";
        }
