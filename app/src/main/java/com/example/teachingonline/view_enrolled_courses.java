...
public class view_enrolled_courses extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_enrolled_courses);
            ...
            try {
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    if (jo.getString("email").equals(studentemail)) {
                       ...
                       enrolled = new ArrayAdapter(view_enrolled_courses.this, android.R.layout.simple_list_item_1, enrolledcoursename);
