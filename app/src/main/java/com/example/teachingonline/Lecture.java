...
public class Lecture extends AppCompatActivity {
    ...
    String URL_EDIT = "http://192.168.1.11/Onlineteaching/editcourse.php";
    String URL_SEC = " http://192.168.1.11/Onlineteaching/getsection.php";
    String URL_AddSec = "http://192.168.1.11/Onlineteaching/addSection.php";
    String URL_Lec = "http://192.168.1.11/Onlineteaching/addLecture.php";
