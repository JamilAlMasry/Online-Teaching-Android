...
public class course_content extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_coursecontent);
    ...
    class getsections extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            json_url = "http://192.168.1.11/Onlineteaching/getsectioncourses.php";
        }
            ...
            try {
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    if(jo.getString("course").equals(crsName.getText().toString())){
                        ...
                        sections = new ArrayAdapter(course_content.this, android.R.layout.simple_spinner_dropdown_item, sectionNames);
    ...
    class getlectures extends AsyncTask<Void, Void, String> {
        ...
        @Override
        protected void onPreExecute() {
            json_url = "http://192.168.1.11/Onlineteaching/getlecturesections.php";
        }
            ...
            try {
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    if(jo.getString("section").equals(textv.getText().toString())){
                        ...
                        lectures = new SectionAdapter(course_content.this, lectureNames);
